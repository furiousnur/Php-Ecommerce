...
//getting the default for customers
  ...
  function getDefault(){
            ...
            $get_orders = "select * from customers_orders where order_status = 'Pending'";
            ...
            if ($count_orders>0) {
              echo "
                ...
                <h3>Please see your orders details by clicking this <a href='../checkout.php?my_orders'> LINK</a></h3>
                </div>  
              ";
            }else{
                echo "
                ...
                <h3>Please see your orders history by clicking this <a href='../checkout.php?my_orders'> LINK</a></h3>
                </div>  
              ";
            }
          }

            // $get_db = "select * from customers_orders where customer_id = '$customer_id' AND order_id = '$or'"
          }
        }
      }
    }
...
//getting the products to display
  function getPro(){
      ...
      while ($row_products=mysqli_fetch_array($run_products)) {
        ...
        $pro_desc = $row_products['procuct_desc'];
...
//getting the category products
  function getCatPro(){
      ...
      while ($row_cat_pro=mysqli_fetch_array($run_cat_pro)) {
        ...
        $pro_desc = $row_cat_pro['procuct_desc'];
...
//getting the brands products
    function getBrandPro(){
        ...
        while ($row_brand_pro=mysqli_fetch_array($run_brand_pro)) {
          ...
          $pro_desc = $row_brand_pro['procuct_desc'];
