...
<body bgcolor="#000">
	<form action=" <?php $_SERVER['PHP_SELF'] ?>" method="post">
		<table width="500" align="center" border="2" bgcolor="#CCC">
			...
			<tr>
				<td align="right">Your Rocket No:</td>
				<td><input type="text" name="rocket_no" required=""></td>
			</tr>
			<tr>
...
<?php 
	...
	if (isset($_POST['confirm'])) {
		...
		$amount = $_POST['amount'];
		$tr_no = $_POST['tr'];
		$c_rocket_no = $_POST['rocket_no'];
		$date = $_POST['payment_date'];

		$complete = 'Complete';

		$insert_payment = "INSERT INTO  rocket_payment(invoice_no, amount, trans_id, c_rocket_no, r_payment_date) values('$invoice', '$amount', '$tr_no', '$c_rocket_no', '$date')";
